    ...
    <script>
        ...
        function refreshMessages(message) {
            $(".media-list").append('<li class="media"><div class="media-body"><div class="media"><div class="media-body">'
                + message.data.message + '<br/><small class="text-muted">' + message.data.author + ' | ' + message.data.createDate + '</small><hr/></div></div></div></li>');
        }
        ...
        $(function(){
            ...
            function sendMessage() {
                ...
                var creationDate = currentdate.getDate() + "/"
                ...
                socket.emit('message', {data: {message: message, author: author, createDate:creationDate}});
                $("#messageText").val("");
